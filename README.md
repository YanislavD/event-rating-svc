...
- **Създаване на рейтинг** - Създаване на нов рейтинг за събитие от потребител
- **Обновяване на рейтинг** - Обновяване на съществуващ рейтинг
- **Изтриване на рейтинг** - Изтриване на рейтинг
...
- `comment` (String, до 500 символа) - Коментар (опционален)
...
**Response:**
- `200 OK` - Рейтингът е обновен успешно
- `400 Bad Request` - Невалидни данни
- `404 Not Found` - Рейтингът не е намерен

#### Изтриване на рейтинг
```
DELETE /ratings/{id}
```

**Response:**
- `204 No Content` - Рейтингът е изтрит успешно
- `404 Not Found` - Рейтингът не е намерен
...
- **Comment** - Максимална дължина 500 символа
